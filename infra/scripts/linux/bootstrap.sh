...
REPO_URL="${REPO_URL:-https://github.com/thekfjie/weixin-household-codex-gateway.git}"
BRANCH="${BRANCH:-main}"
APP_DIR="${APP_DIR:-/opt/weixin-household-codex-gateway}"
DATA_DIR="${DATA_DIR:-/var/lib/weixin-household-codex-gateway}"
PORT="${PORT:-18080}"
...
示例：
  curl -fsSL https://raw.githubusercontent.com/thekfjie/weixin-household-codex-gateway/main/infra/scripts/linux/bootstrap.sh | LOGIN_ROLE=admin PORT=18080 bash
EOF
}
